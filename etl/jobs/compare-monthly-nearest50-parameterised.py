...
if len(workflow_present) == 2:
    ...
    args = {
        ...
        'SOURCE_TABLE_NAME' : workflow_run_properties['AGGREGATION_TARGET_TABLE_NAME'],
        'TARGET_TABLE_NAME' : workflow_run_properties['NEAREST50_TARGET_TABLE_NAME'],
        'TARGET_PATH'       : workflow_run_properties['NEAREST50_TARGET_PATH'],
